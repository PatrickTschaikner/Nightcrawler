...
public class LoseScreen implements Screen {
    ...
    public LoseScreen(MyGdxGame game1){
        game = game1;
        stage = new Stage(new ScreenViewport());

        Label title = new Label("You Died!", MyGdxGame.gameSkin,"big-black");
        ...
        TextButton playButton = new TextButton("Return to Title",MyGdxGame.gameSkin);
        ...
        TextButton optionsButton = new TextButton("Restart",MyGdxGame.gameSkin);
